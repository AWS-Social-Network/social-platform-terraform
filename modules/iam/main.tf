...
resource "aws_iam_openid_connect_provider" "github" {
  ...
  # This is the thumbprint for the GitHub Actions CA. 
  # AWS uses this to verify the TLS certificate of the provider.
    ...
    Statement = [
      {
        ...
        Condition = {
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:AWS-Social-Network/*"
          },
          StringEquals = {
...
resource "aws_iam_policy" "github_actions_policy" {
  ...
  description = "Permissions for GitHub Actions to deploy EKS and Lambda"
